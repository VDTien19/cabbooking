...
<div class="d-flex align-items-center justify-content-center">
  <!-- /.login-logo -->
  <div class="d-flex  justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark" style="height: 100vh;">
    <div class="card card-outline card-green w-75">

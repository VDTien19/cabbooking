                    ...
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <strong class="">New Password</strong><small class="text-muted"><em> (Fill the password fields above only if you want to update your password.)</em></small>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="input-group">
                                ...
                                <strong class="">Confirm New Password</strong>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <strong class="">Current Password</strong>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">

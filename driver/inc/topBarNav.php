...
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient-green fixed-top" id="topNavBar">
                    ...
                    <div class="d-flex align-items-end">
                      <div class="navbar-nav nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span><img src="<?= validate_image($_settings->userdata('image_path')) ?>" alt="user_avatar" id="user_avatar" class="img-fluid img-thumbnail rounded-circle border-dark"></span> <span class="hello-name">Hello, <?= $_settings->userdata('cab_driver') ?></span>
                        </a>

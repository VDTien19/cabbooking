...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-green elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-gradient-green text-sm text-light">
        ...
        <span class="brand-text font-weight-bold" style="font-size: 16px"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->

...
<div class="card card-outline card-purple rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form">
			...
			<div class="form-group">
				<label for="cab_reg_no" class="control-label">Biển số / Số đăng ký xe </label>
			...
			<div class="form-group">
				<label for="driver_contact" class="control-label">Số điện thoại</label>
			...
			<div class="form-group">
				<label for="driver_address" class="control-label">Địa chỉ tài xế</label>
			...
			<div class="form-group col-md-6">
				<label for="" class="control-label">Ảnh xe</label>
				<div class="custom-file">
					<input type="file" class="custom-file-input rounded-circle" id="car-file" name="car_image" onchange="displayImg2(this,$(this))">
					<label class="custom-file-label" for="car-file">Choose file</label>
				</div>
			</div>
			<div class="form-group col-md-6 d-flex justify-content-center">
				<img src="<?php echo validate_image(isset($image_car) ? $image_car : "") ?>" alt="" id="cimg2" class="img-fluid img-thumbnail">
			</div>
            <div class="form-group">
...
<script>
	...
	window.displayImg2 = function(input,_this) {
	    if (input.files && input.files[0]) {
	        var reader = new FileReader();
	        reader.onload = function (e) {
            ...
            $('#cimg2').attr('src', "<?php echo validate_image(isset($image_car) ? $image_car : "") ?>");
            _this.siblings('.custom-file-label').html("Choose file")
        }
	}
